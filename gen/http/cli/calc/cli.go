...
func ParseEndpoint(
	...
	var (
		...
		calcMultiplyAFlag = calcMultiplyFlags.String("a", "REQUIRED", "multiplicand")
		calcMultiplyBFlag = calcMultiplyFlags.String("b", "REQUIRED", "multiplier")
	)
...
func calcUsage() {
	fmt.Fprintf(os.Stderr, `The calc service performs calculations on numbers.
Usage:
